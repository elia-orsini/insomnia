  ...
  return (
    <div>
      ...
      show ? 
        ...
        : 
        <button className="rotate-[270deg] z-10 absolute bottom-32 xl:bottom-12 right-6 xl:right-14 bg-black rounded-full text-white text-center border px-2 h-12 xl:h-16 w-12 xl:w-16 p-0 border-white flex hover:bg-white hover:text-black hover:border-black transition-colors duration-500" onClick={() => setShow(!show)}>
